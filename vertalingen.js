...
const VERTALINGEN = {
  ...
  "al.lead":           { nl: "De snelste manier om erachter te komen of een vakgebied bij je past, is praten met iemand die er al in zit. Studenten die vóór jou bij ons langskwamen werken nu in klimaatbeleid, consultancy, onderzoek, waterbeheer en hun eigen onderneming, en ze staan open voor de studenten die na hen komen. Vertel ons wie je wilt spreken, wij gaan onze lijst langs en sturen je hun gegevens zodat je zelf contact kunt opnemen." },
  ...
  "al.vragen.lead":    { nl: "Van alles eigenlijk. Deze komen het vaakst voorbij." },
  ...
  "al.s1.kop":         { nl: "Jij beschrijft wie je zoekt" },
  "al.s1.tekst":       { nl: "Het vakgebied en het soort organisatie dat je zoekt. Twee minuten." },
  "al.s2.kop":         { nl: "Wij gaan de lijst langs" },
  "al.s2.tekst":       { nl: "We gaan onze alumni zelf af en kiezen iemand wiens pad echt op het jouwe lijkt." },
  "al.s3.kop":         { nl: "Je krijgt hun gegevens" },
  "al.s3.tekst":       { nl: "We mailen je hun LinkedIn-profiel, en een telefoonnummer als ze dat hebben gegeven, met een regel over wie ze zijn." },
  "al.s4.kop":         { nl: "Jij neemt contact op" },
  "al.s4.tekst":       { nl: "Stuur ze eerst een bericht. Willen jullie dat allebei, dan komt een gesprek daarna." },

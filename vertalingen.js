...
const VERTALINGEN = {
  ...
  "lok.gelukt":        { en: "We've got it, and a copy is already in your inbox. We read every question by hand, so keep an eye on your email, because that is where our answer comes. We'll get back to you as soon as we can. If we think someone else can help you better than {naam}, we'll say so and tell you why.",
                         nl: "Hij is binnen, en er staat al een kopie in je inbox. We lezen elke vraag met de hand, dus houd je mail in de gaten, want daar komt ons antwoord. We komen zo snel mogelijk bij je terug. Denken we dat iemand anders je beter kan helpen dan {naam}, dan zeggen we dat erbij, met de reden." },
